...
//	}
	...
	@GET
	@Path("/getMsisdnAndRegleCount2")
	@Produces(MediaType.APPLICATION_JSON)
	public List<Object[]> getMsisdnAndRegleCount(@QueryParam("page") int page, 
	                                             @QueryParam("pageSize") int pageSize) {
	    return fraude_service.getMsisdnAndRegleCount2(page, pageSize);
	}
	...
	@GET
	@Path("/getMSISDNsByRegle2/{regle_id}/{page}/{pageSize}")
	@Produces(MediaType.APPLICATION_JSON)
	public List<Object[]> getMSISDNsByRegle(@PathParam("regle_id") Long regle_id, 
	                                        @PathParam("page") int page, 
	                                        @PathParam("pageSize") int pageSize) {
	    return fraude_service.getMSISDNsByRegle2(regle_id, page, pageSize);
	}
